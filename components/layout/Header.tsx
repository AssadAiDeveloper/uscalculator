...
const S = {
  ...
  searchIn: { width:200, background:"rgba(255,255,255,.12)", color:"#fff", border:"1.5px solid rgba(255,255,255,.25)", borderRadius:10, padding:"7px 36px 7px 14px", fontSize:13, outline:"none" },
      ...
      <div style={S.topBar}>
        ...
        <Link href="/" style={S.logo} aria-label="USCalculator.net home">
          <Image
            ...
            height={54}
            priority
            style={{ height: 70, width: "auto", maxWidth: 200 }}
          />
        </Link>
